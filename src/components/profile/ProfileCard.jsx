...
function ProfileCard({ setProcess, activeProcess }) {
  return (
    <div className="flex flex-col border border-gray-200 rounded-2xl w-full lg:max-w-sm shadow-xl p-5">
        ...
        <div className="w-full flex flex-col items-start mt-6 sm:mt-10 font-bold cursor-pointer">
          {[
            ...
            <button
              ...
              className={`flex justify-between items-center w-full h-11 sm:h-13 px-4 sm:px-5 rounded-2xl transition-colors text-sm sm:text-base cursor-pointer
                ${activeProcess === label
